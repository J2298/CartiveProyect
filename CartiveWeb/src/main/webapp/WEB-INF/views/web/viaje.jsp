    		...
    		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
  			...
  			<div class="collapse navbar-collapse" id="navbarNav" align="left">
  				<ul class="navbar-nav ml-auto">
  					<li class="nav-item">
			        	<a class="nav-link" style="color:white" href="<%=request.getContextPath()%>/inicio"><i class="fa fa-road"></i> Buscar Destino</a>
			      	</li>
  					<li class="nav-item">
			        	<a class="nav-link" style="color:white" href="#"><i class="fa fa-file-text-o"></i> Imprimir Pasaje</a>
			      	</li>
			      	<li class="nav-item">
			        	<a class="nav-link" style="color:white" href="<%=request.getContextPath()%>/mistickets/${uid}"><i class="fa fa-ticket"></i> Mis Tickets</a>
			      	</li>
			      	<li class="nav-item">
			        	<a class="nav-link" style="color:white" href="#"><i class="fa fa-user-o"></i>${alluser.nombres} ${alluser.apellidos}</a>
			      	</li>
			      	<li class="nav-item">
			        	<a class="nav-link" style="color:white" href="<%=request.getContextPath()%>/login"><i class="fa fa-sign-out"></i> Cerrar Sesion</a>
			      	</li>
    			</ul>
  			</div>
		</nav>
